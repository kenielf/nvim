...
-- }
--
-- local alt_silicon = require("silicon")
-- alt_silicon.setup(alt_options)
--
-- vim.keymap.set(
--     "v", "<leader>sC", alt_silicon.screenshot,
--     { desc = "Take a screenshot of the code using the alternative scheme", silent = true }
-- )
